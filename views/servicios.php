    ...
    <tbody>
      ...
      ?>
        <tr>
          ...
          <td>
            <!-- EDITAR SERVICIO -->
            <a href=<?php echo str_replace(' ', '%20', '../forms/editService.php?nombre=' . $serv['nombre_servicio'] . '&detalle=' . $serv['detalle'] . '&costo=' . $serv['costo'] . '&fecha=' . $serv['fecha'] . '&servicio_id=' . $serv['id'] . '&mascota_id=' . $mascID . '&doctor_id=' . $docID) ?>>
