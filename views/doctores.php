      ...
      <?php foreach ($doctores as $doc){?>
        <tr>
          ...
          <td align="end">
            ...
            <a class="text-light text-decoration-none" href=<?php echo str_replace(' ','%20','../forms/editDoctor.php?nombre='.$doc['nombre_apellido'].'&tel='.$doc['telefono'].'&dir='.$doc['direccion'].'&cargo='.$doc['cargo'].'&id='.$doc['id'] ) ?>>
