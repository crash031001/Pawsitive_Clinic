...
<head>
  ...
  <title>Doctores | Pawsitive</title>
...
<body>
  ...
  <span class="header mt-5 text-light fw-bold">Doctores
    <a href="../forms/addDoctor.html"><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-plus-square-fill icon add" viewBox="0 0 16 16">
    ...
    <tbody>
      <?php foreach ($doctores as $doc) { ?>
        <tr>
          ...
          <td align="end">
            <!-- Redireccion al form de editar  -->
            <a class="text-light text-decoration-none" href=>
              <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-pencil-fill mx-1 <?php echo str_replace(' ', '%20', '../forms/editDoctor.php?nombre=' . $doc['nombre_apellido'] . '&tel=' . $doc['telefono'] . '&dir=' . $doc['direccion'] . '&cargo=' . $doc['cargo'] . '&id=' . $doc['id']) ?> icon" viewBox="0 0 16 16">
                <path d="M12.854.146a.5.5 0 0 0-.707 0L10.5 1.793 14.207 5.5l1.647-1.646a.5.5 0 0 0 0-.708zm.646 6.061L9.793 2.5 3.293 9H3.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.207zm-7.468 7.468A.5.5 0 0 1 6 13.5V13h-.5a.5.5 0 0 1-.5-.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.5-.5V10h-.5a.5.5 0 0 1-.175-.032l-.179.178a.5.5 0 0 0-.11.168l-2 5a.5.5 0 0 0 .65.65l5-2a.5.5 0 0 0 .168-.11z" />
              </svg>
            </a>
            <!-- Eliminar  -->
            <a class="text-light text-decoration-none eliminar" data-id=<?php echo $doc['id'] ?>>
  ...
  <form method="post" action="../api/post/deleteDoctor.php" class="mod">
