...
<head>
  ...
  <title>Clientes | Pawsitive</title>
    ...
    <tbody>
      <?php foreach ($clientes as $client): ?>
        <tr>
          ...
          <td align="end">
            <!-- EDITAR CLIENTE  -->
            <a href=<?php echo str_replace(' ', '%20', '../forms/editCliente.php?nombre=' . $client['nombre_apellido'] . '&tel=' . $client['telefono'] . '&dir=' . $client['direccion'] . '&zona=' . $client['zona'] . '&id=' . $client['id']) ?>>
