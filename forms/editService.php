...
$DOCTOR = $_GET['doctor']; // id
$MASCOTA = $_GET['mascota']; // id
        ...
        <form action="../api/post/updateServices.php" id="create" method="post" class="fs-4">
          ...
          <div class="row row-cols-md-2">
            <div class="d-flex flex-column">
              ...
              <input class="p-3 inps" type="date" placeholder="Ej. Aplicación de vacunas necesarias" name="fecha" id="inputTelefono"
